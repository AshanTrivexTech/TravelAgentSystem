	...
	<div class="m-subheader ">
		<div class="d-flex align-items-center">
            ...
            <div class="col-xl-4 order-1 order-xl-2 m--align-right">
											<a href="{{route('district_index')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
												<span>
 ...
 <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" method="POST" >
                  {{csrf_field()}}
                    <div class="m-portlet__body">
                        	...
                        	<input placeholder="unique name" id="name" name="name" type="text" class="form-control m-input"  maxlength="191" value="{{$districts->dist_name}}" >
							<span class="m-form__help text-danger">
									* Required
												...
												<input placeholder="unique code" id="code" name="code" type="text" class="form-control m-input"  maxlength="16" value="{{$districts->code}}">
												<span class="m-form__help text-danger">
														* Required
													 </span>
															<div class="form-control-feedback">
												...
												<div class="col-lg-6">
													<label class="form-control-label">
													  ...
													  <select class="form-control" name="country" id="country">
														 ...
														 <option value="{{$country->id}}"  @if($country->id==$districts->country_id) selected @endif   >{{$country->country_name}}</option>
															@endforeach
														</select>
														<span class="m-form__help text-danger">
																* Required
			...
			$("#frm_submit").click(function(event) {
					...
					//console.log(id);		  
						...
						$.ajax({
							...
							method: "POST",
								data: {id:id,name:name,code:code,country:country},
								...
								//if Added 
									if(data=='updated'){
										$('.alert').hide();
										swal("District Updated successfully!", ""+name, "success");
										window.location.replace('{{Route('district_index')}}');
