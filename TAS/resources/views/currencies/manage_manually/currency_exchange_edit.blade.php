            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group  row">
                    <div class="col-lg-3">
                        ...
                        <input disabled  class="form-control m-input numeric_only" id="currency_A" name="currency_A" type="text" value="{{ $currency_edit->type_A}}">	
                    </div>
                    ...
                    <input disabled  class="form-control m-input numeric_only" id="currency_B" name="currency_B" type="text" value="{{ $currency_edit->type_B}}">	
                            </div>
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <input  class="form-control m-input numeric_only" id="amount" name="amount" type="text" value="{{ $currency_edit->amount}}">
        ...
        $("#frm_submit").click(function(event) {
                ...
                //   console.log(currency_type);
                    ...
                    $.ajax({
                        ...
                        url: '{{Route('currencyEx_update')}}',
                        method: "POST",
                            data: {currency_A:currency_A,currency_B:currency_B,amount:amount,id:id,frm_date:frm_date,to_date:to_date},
                            ...
                            //if Added 
                                if(data=='updated'){
                                    $('.alert').hide();
                                    swal("Currency Exchange Rate Updated successfully!",  "success");
