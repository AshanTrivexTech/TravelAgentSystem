...
@section('content')
    ...
    <div class="m-portlet">
                ...
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" method="POST" action="{{route('city_update',$city->id)}}">
                  {{csrf_field()}}
                    <div class="m-portlet__body">
                        	...
                        	<input placeholder="unique name" id="name" name="name" type="text" class="form-control m-input mxl_code"   value="{{ $city->city_name}}" >
							<span class="m-form__help text-danger">
									* Required
												...
												<input placeholder="unique code" id="code" name="code" type="text" class="form-control m-input mxl_cityname"   value="{{ $city->city_code}}">
												<span class="m-form__help text-danger">
														* Required
													</span>
															<div class="form-control-feedback">
											...
											<div class="form-group m-form__group has-danger row">
															...
															<option value="{{$district->id}}" @if($city->district_id==$district->id) selected @endif>{{$district->dist_name}}</option>
															@endforeach		
															</select>
															<span class="m-form__help text-danger">
																	* Required
			...
			$("#frm_submit").click(function(event) {
					...
					//console.log(id);		  
						...
						$.ajax({
							...
							method: "POST",
								data: {id:id,name:name,code:code,district_id:district_id},
