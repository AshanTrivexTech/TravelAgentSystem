    ...
    <div class="d-flex align-items-center">
        ...
        <div>
            <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                 @if($add_pv==1)
                <a href="{{route('tax_create')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                    <span>
            ...
            <table class="table table-bordered table-hover table-checkable">
                <thead>
                    <tr>  <th style="text-align: center">ID</th>
                          ...
                          <th style="text-align: center">Tax Order</th>
                ...
                <tbody id="tb_sr">
		           ...
		           <tr style="text-align:center"> 
                          ...
                          <td class="m-datatable__cell--right" style="text-align: center">
                            ...
                            @if($edit_pv==1)
                             <a href="{{route('tax_edit',$tax->id)}}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">
                                <i class="la la-edit"></i>
                             </a>
                            @endif

                             @if($del_pv==1)
                             <a id= "{{$tax->id}}" onclick="deleteAccept({{$tax->id}})"
