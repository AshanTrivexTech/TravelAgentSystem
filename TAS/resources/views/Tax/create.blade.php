...
<div class="m-content">
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" method="POST"  id="add_TaxFrm">
                {{ csrf_field() }}
            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    <div class="col-lg-6">
                        ...
                        <input id="tax_name" name="tax_name" class="form-control"  type="text" value="" autofocus>
                    ...
                    <div class="col-lg-3">
                      ...
                      <input class="form-control mxl_code" id="rate" name="rate" type="text" value="" >
                      <div class="form-control-feedback">
                    ...
                    <div class="col-lg-3">
                          ...
                          <input class="form-control mxl_code" id="t_order" name="t_order" type="text" value="" >
                          <div class="form-control-feedback">
        ...
        $( "#frm_submit").click(function( event ) { 
                ...
                var cur_url=window.location.href;
                  ...
                  $.ajax({
                    ...
                    url: '{{Route('tax_store')}}',
                    method: "POST",
                    data: {tax_name:tax_name,rate:rate,status,status,tax_order:tax_order},
