    ...
    <div class="d-flex align-items-center">
        ...
        <div>
            <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                <a href="{{route('tax_index')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                    <span>
...
<div class="m-content">
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" method="POST" id="" >
                {{ csrf_field() }}
            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    <div class="col-lg-6">
                        ...
                        <input id="tax_name" name="tax_name" class="form-control"  type="text" value="{{ $tax_edit->tax_name}}" autofocus >
                    ...
                    <div class="col-lg-3">
                      ...
                      <input class="form-control mxl_code" id="rate" name="rate" type="text" value="{{ $tax_edit->rate}}" >
                      <span class="form-group text-danger">
                            * Required
                      </span>	
                    ...
                    <div class="col-lg-3">
                          ...
                          <input class="form-control mxl_code" id="t_order" name="t_order" type="text" value="{{$tax_edit->tax_order}}" >
                          <div class="form-control-feedback">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="m-radio-list">
                                <label class="m-radio m-radio--state-success">
                                    <input type="radio" name="status" id="active" @if(($tax_edit->status)==1) checked @endif> Active
                                    <span></span>
                                </label>
                                <label class="m-radio m-radio--state-brand">
                                    <input type="radio" name="status" id="inactive" @if(($tax_edit->status)==0) checked  @endif  > In-active
                                    <span></span>
                                </label>
        ...
        $("#frm_submit").click(function(event) {
                ...
                //   console.log(currency_type);
                    ...
                    $.ajax({
                        ...
                        url: '{{Route('tax_update')}}',
                        method: "POST",
                            data: {tax_name:tax_name,rate:rate,status:status,tax_order:tax_order,id:id},
                            ...
                            //if Added 
                                if(data=='updated'){
                                    $('.alert').hide();
                                    swal("Tax Updated successfully!", ""+tax_name, "success");
                                    window.location.replace('{{Route('tax_index')}}');
