        ...
        function appyAll(){
            ...
            if(grcout!=0){
                ...
                {   
                    ...
                    // {   
                    //     var guidetypeguidelangname = $('#guide_typelngname_1_'+RowsCount).html();
                    //     var GuideTypeId = $('#guide_type_id_1_'+RowsCount).val();
                    //     var langId = $('#guide_lang_id_1_'+RowsCount).val();
                    //     var guidefee = parseFloat($('#guide_fee_1_'+RowsCount).val());
                    //     var langCom = parseFloat($('#guide_com_1_'+RowsCount).val());
                    //     var guideRoomcrCode = $('#guide_rm_crid_1_'+RowsCount).val();
                    //     var GuideRoomamount = parseFloat($('#guide_rm_am_1_'+RowsCount).val());
                    //     var guideRoomid = $('#guide_rm_id_1_'+RowsCount).val();
                    //     var baseCurrncyGuide ='{{$baseCurrncyCode}}';
                    //     var guideRm_ex_rate = parseFloat($('#guide_rm_cr_exrate_1_'+RowsCount).val());
                    //     var roomCom = parseFloat($('#guide_rm_com_1_'+RowsCount).val());
                    ...
                    //    cur_Date.append($('<tr style="text-align: center;" class="RemoveGuide_'+dayId+'_'+RowsCount+'"></tr>').attr('id','gtbtr_'+dayId+'_'+RowsCount)                                 
                    //                      .html('<td class="RemoveGuide_'+dayId+'_'+RowsCount+'">'+
                    //                             '<strong id="guide_typelngname_'+dayId+'_'+RowsCount+'" class="RemoveGuide_'+dayId+'_'+RowsCount+'">'+guidetypeguidelangname+'</strong>'+
                    //                             '<input class="RemoveGuide_'+dayId+'_'+RowsCount+'" id="guide_type_id_'+dayId+'_'+RowsCount+'" type="hidden" value="'+GuideTypeId+'">'+
                    //                             '<input class="RemoveGuide_'+dayId+'_'+RowsCount+'" id="guide_lang_id_'+dayId+'_'+RowsCount+'" type="hidden" value="'+langId+'">'+
                    //                             '</td>'+
                    //                             '<td class="RemoveGuide_'+dayId+'_'+RowsCount+'" style="white-space: nowrap; overflow: hidden;" width="15%">'+
