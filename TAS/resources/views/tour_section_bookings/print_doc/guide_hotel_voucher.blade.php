              ...
              <table width="100%" class="table table-sm table-bordered">
                  <thead>
                      <tr width="200px" style="text-align: center;">
                          <th colspan="4"><h3>Guide Hotel Voucher</h3></th>
                      </tr>
                  ...
                  <tbody>
                    ...
                    <td>{{Carbon\Carbon::now()}}</td>
                        ...
                        <tr>
                            ...
                            <td width="25%">{{$voucherHead[0]->guide_hotel_voucher_no}}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                              ...
                              <td>{{$voucherData[0]->hotel_name}}</td>
                        </tr>
                    </tbody>
              </table>
           </div>
      ...
      <div class="row">
            <div class="col-md-12">
                ...
                <tbody style="text-align: center;">
                        @foreach($voucherData as $guidehotel_details)
                    <tr>
                            
                    {{-- @foreach($sup_guide->all() as $supguide) --}}
                        {{-- @if($supguide->id==$guidehotel_details->supplier_id)                                                          --}}
                    <td>{{($guidehotel_details->guide_name)}}</td>
                        {{-- @endif --}}
                    {{-- @endforeach --}}
                    <td>{{$guidehotel_details->tour_date}}</td>
                    <td>{{$guidehotel_details->g_type}}</td>
                    <td>{{$guidehotel_details->gr_types}}</td>
                    <td>{{$guidehotel_details->room_rate}}</td>
                    {{-- <input type="hidden" {{$total+=$guidehotel_details->room_rate}} >                  --}}
                    </tr>
                   @endforeach
                </tbody>
            </table>
