     ...
     <div class="m-portlet m-portlet--mobile">
         ...
         <div class="m-portlet__body">
             ...
             <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                        ...
                        <input required placeholder="" disabled id="pb_date" name="pb_date" type="text" class="form-control m-input"  value=""> 
                            </div>
                                <div class="col-lg-2">
                                        <label class="form-control-label">
                                          Confirmed By :
                                        </label>
                            <input required placeholder=""  id="confirmed_by" name="confirmed_by" type="text" class="form-control m-input"  value="">                      
                                </div>
                                <div class="col-lg-4">
                                        <label class="form-control-label">
                                          Remarks :
