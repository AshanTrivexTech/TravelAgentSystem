         ...
         <div class="m-portlet__body">
             ...
             <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                         <div class="form-group m-form__group  row">
                            ...
                            <input required placeholder="" disabled id="max_psng" name="max_psng" type="text" class="form-control m-input"  value="">                      
                                </div>
                                <div class="col-lg-2">
                                        <label class="form-control-label">
                                          Mileage :
                                        </label>
                            <input required placeholder=""  id="mileage" name="mileage" type="text" class="form-control m-input"  value="">                      
                                </div>
                                <div class="col-lg-2">
                               ...
                               <div class="form-group m-form__group  row">
                                    ...
                                    <select class="form-control" id="to_date" name="to_date">
                                        <option value="0">Please select...</option>
                                    </select>    
                                    </div>
                            </div>
             ...
             <table class="table table-bordered table-hover table-checkable" id="" width:"100%">
                 ...
                 <tbody>
                        ...
                        <tr style="text-align: center;">                       
                                <td style="text-align: right; padding: 8px 0px 0px 0px" colspan="6"><label><b>Total Milage&nbsp;:&nbsp;&nbsp;</b></label></td>
