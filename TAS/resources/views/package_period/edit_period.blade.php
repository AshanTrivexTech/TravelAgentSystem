                                        ...
                                        <div class="m-portlet__body">
											<div class="form-group m-form__group has-danger row">
												<div class="col-lg-6">
                                                    ...
                                                    <input required placeholder="Titler Title" id="title" name="title" type="text" class="form-control m-input" maxlength="5" value="{{$period_data->title}}">
												...
												<div class="col-lg-6">
                                                        ...
                                                        @foreach($period->all() as $pr)
                                                        <option value="{{$pr->type}}">{{$pr->type}}</option>
                                                        @endforeach
											...
											<div class="form-group m-form__group has-danger row">
                                               ...
                                               name="ins_exDate" type="text"
														class="form-control dtpic-format" value="{{$period_data->fr_date}}">
														<span class="m-form__help text-danger">
																* Required
															</span>
                                                </div>
											   ...
											   class="form-control dtpic-format" value="{{$period_data->to_date}}">
											   <span class="m-form__help text-danger">
													* Required
												</span>
												</div>
			...
			$( "#frm_submit").click(function( event ) {
					...
					// console.log(code);
					  ...
					  $.ajax({
						...
						url: '{{Route('update_period')}}',
						method: "POST",
						data: {id:id,title:title,type:type,m_datepicker_1:m_datepicker_1,m_datepicker_2:m_datepicker_2,status:status},
						success: function(data) {
							...
							if(data=='updated'){
								$('.alert').hide();
								swal("Package Period update successfully completed!", ""+title, "success");
