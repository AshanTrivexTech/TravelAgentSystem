...
<div class="m-portlet">
 ...
 <form class="" method="POST" action="{{route('tour-store')}}">
                            {{csrf_field()}}
   ...
   <div class="m-portlet__body">
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-3">
               <div class="m-form__group form-group">
                    ...
                    <input  placeholder="0" disabled type="number" id="no_of_days" onchange="getdate()" class="" name="no_of_days"/>
        ...
        <div class="form-group m-form__group row">
            <div class="col-lg-6">
                ...
                <input name="start_date" type="text" onchange="getdate()" class="form-control m-input" placeholder="Select date" id="m_datetimepicker_6">
            ...
            <div class="col-lg-6">
                ...
                <input  name="end_date" type="text"  class="form-control m-input" placeholder="Select date" id="m_datetimepicker_8">
...
<script type="text/javascript">
   ...
   $('input[type=radio][name=date_range]').change(function () {
            if (this.value == 'days') {
                $('#m_datetimepicker_6').html('Estimated Start Date');
                $('#m_datetimepicker_8').html('Estimated End Date');
