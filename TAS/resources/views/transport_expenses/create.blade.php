...
<meta name="_token" content="{{csrf_token()}}" />
    ...
    <div class="m-portlet">
									...
									<form method="" action=""  id="add_TECFrm" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
                                    {{-- {{csrf_field()}} --}}
                                        <div class="m-portlet__body">
											<div class="form-group m-form__group has-danger row">
												<div class="col-lg-6">
                                                    ...
                                                    <input required placeholder="Transport Expenses Title" id="te_cat" name="te_cat" type="text" class="form-control m-input "  value="">
												...
												<div class="col-lg-6">
														...
														<input required placeholder="Amount" id="amount" name="amount" type="text" class="form-control m-input numeric_only "  value="">
			...
			$( "#frm_submit").click(function( event ) {
					...
					$.ajaxSetup({
					  ...
					  $.ajax({
						...
						url: '{{Route('transportExpenses_store')}}',
						method: "POST",
						...
						success: function(data) {
							...
							if(data=='added'){
								$('.alert').hide();
								swal("Transport Expenses Category Add successfully completed!", ""+category, "success");
								$("#add_TECFrm")[0].reset();
