...
<meta name="_token" content="{{csrf_token()}}" />
    ...
    <div class="m-portlet">
									...
									<!--begin::Form-->
									<form method="POST" id="add_miscatFrm" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
                                        ...
                                        <div class="m-portlet__body">
												...
												<div class="form-group m-form__group has-danger row">
														<div class="col-lg-6">
																...
																<input required placeholder="Category Name" id="mcat_name" name="mcat_name" type="text" class="form-control mxl_name"  value="">
															...
															<div class="col-lg-3">
																	...
																	<input required placeholder="Number of PAX" id="mcat_pax" name="mcat_pax" type="text" class="form-control mxl_phone"  value="">
																	  <span class="form-group text-danger"> * Required</span>
																</div>
																<div class="col-lg-3">
																	<label class="form-control-label">
																	...
																	<select class="form-control m-bootstrap-select m_selectpicker"   name="mcat_crncy_rt" id="rate_ctgry">
																		<option value="0">Please select...</option>
																		 @foreach($misRatectgrys as $misRatectgry)
																		<option value="{{$misRatectgry->id}}">{{$misRatectgry->rate_ctgry}}</option>
																		@endforeach
												...
												<div class="form-group m-form__group has-danger row">
													...
													<div class="col-lg-6">
															...
															<input required placeholder="Rate" id="mcat_rate" name="mcat_rate" type="text" class="form-control mxl_phone numeric_only"  value="">
															  <span class="form-group text-danger"> * Required</span>
														</div>
													<div class="col-lg-6">
															<label class="form-control-label">
															...
															<select class="form-control m-bootstrap-select m_selectpicker" data-live-search="true"  name="mcat_crncy_rt" id="mcat_crncy_rt">
																<option value="0">Please select...</option>
...
<script>
		$(document).ready( function(){
			...
			$( "#frm_submit").click(function( event ) {
					...
					var crncy_rt=$('#mcat_crncy_rt').val();
					var rate_ctgry=$('#rate_ctgry').val();
					var cur_url=window.location.href;	  
						//Send Ajax request 
					  $.ajax({
						
						url: '{{Route('miscellaneousCategory_store')}}',
						method: "POST",
						data: {mcat_name:mcat_name,mcat_pax:mcat_pax,mcat_rate:mcat_rate,crncy_rt:crncy_rt,rate_ctgry:rate_ctgry},
						success: function(data) {
							...
							if(data=='added'){
								$('.alert').hide();
								swal("Miscellaneous category add successfully completed!", ""+mcat_name, "success");
								$("#add_miscatFrm")[0].reset();
