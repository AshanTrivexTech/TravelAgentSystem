    ...
    <div class="m-portlet">
									...
									<form method="POST" id="" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
                                        ...
                                        <div class="m-portlet__body">
											<div class="form-group m-form__group has-danger row">
												<div class="col-lg-2">
													...
													<input required placeholder="unique code" id="code" name="code" type="text" class="form-control mxl_code"  value="{{$sup->code}}">
													...
													<input required placeholder=" name" id="name" name="name" type="text"  class="form-control mxl_name"  value="{{$sup->sup_name}}">
														<span class="form-group text-danger"> * Required</span>
													</div>
										...
										<div class="form-group m-form__group  row">
													...
													<textarea placeholder="Address" id="address" name="address" class="form-control"   required>{{$sup->address}}</textarea>
											...
											<div class="form-group m-form__group  row">
												...
												<input placeholder="011XXXXXXXX" id="mobile" name="mobile" type="tel" class="form-control mxl_phone" @if($tel->contact=='') value="Not available"  @else value="{{$tel->contact}}" @endif >
												</div>
												<div class="col-lg-4">
														<label class="form-control-label">
														Email  :
														</label>
													<input placeholder="Email" id="email" name="email" type="email" class="form-control" @if($email_A->contact=='') value="Not available"  @else value="{{$email_A->contact}}" @endif  required>
			...
			$( "#frm_submit").click(function( event ) {
					...
					// console.log(code);
					  ...
					  $.ajax({
						...
						url: '{{Route('update_miscellanies')}}',
						method: "POST",
						data: {id:id,s_id:s_id,mobile:mobile,address:address,email:email,name:name,code:code,msc_type:msc_type,msc_cat:msc_cat},
						success: function(data) {
							...
							if(data=='updated'){
								$('.alert').hide();
								swal("Miscellanies update successfully completed!", ""+name, "success");
