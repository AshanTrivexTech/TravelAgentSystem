    ...
    <div class="d-flex align-items-center">
        ...
        <div>
            <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                 @if($add_pv==1)
                <a href="{{route('market_load')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                    <span>
        ...
        <div class="m-portlet__body">
            ...
            <table class="table table-bordered table-hover table-checkable">
                ...
                <tbody id='tb_sr'>
                    ...
                    @foreach($mkt->all() as $market)
                    <tr>
                    <td style="text-align: center">{{$market->id}}</td>
                    <td style="text-align: center">{{$market->m_code}}</td>
                    <td>{{$market->market_name}}</td>
                    {{-- <td style="text-align: center">{{$market->code}}</td> --}}
                    <td style="text-align: center">
                       @if($edit_pv==1)
                         @if($market->id!=1)
                      <a href="{{route('market_edit',$market->id)}}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">
