        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    Update Vehicle:{{$vehicleDetail->id}}
												</h3>
                </div>
            </div>
        </div>
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6">
                        <label class="form-control-label">
                         ...
                         <input required class="form-control" placeholder="unique name" id="title" name="title" type="text" value="{{$vehicleDetail->title}}" class="validate"
                                           maxlength="191" value="">
                        ...
                        <select required class="form-control" name="vehicle_type" id="vehicle_type">
                              ...
                              @foreach ($vehicleType_list as $vehicletype)
                                <option value="{{$vehicletype->id}}" 
                                    @if ($vehicleDetail->vehicle_type_id == $vehicletype->id)
                                        Selected
                                    @endif
                ...
                <div class="form-group m-form__group  row">
                        ...
                        <select required class="form-control" name="supplier" id="supplier">
                            ...
                            @foreach ($vehicleSup_List as $suplier)
                                <option value="{{$suplier->id}}"  
                                    @if ($vehicleDetail->supplier_id == $suplier->id)
                                        Selected
                                    @endif
                                    
                                    >{{$suplier->sup_name}}</option>
                            @endforeach
                        </select>
                        <span class="m-form__help text-danger">
                                * Required
                    ...
                    <div class="col-lg-6">
                        ...
                        <input required class="form-control" placeholder="Unique Vehicle Number" id="vehicle_no" name="vehicle_no" type="text"
                                 maxlength="16" value="{{$vehicleDetail->reg_no}}">
                                 <span class="m-form__help text-danger">
                                        * Required
                                    </span>
                        <div class="form-control-feedback">
                ...
                <div class="form-group m-form__group  row">
                 <div class="col-lg-6">
                        ...
                        <input placeholder="License Expire Date" id="m_datepicker_1_modal"
                                           ...
                                           class="form-control dtpic-format" value="{{$vehicleDetail->licence_exp_date}}">
                                           <span class="m-form__help text-danger">
                                                * Required
                                            </span>
                    ...
                    <div class="col-lg-6">
                            ...
                            <input placeholder="Insurance Expire Date" id="m_datepicker_2_modal"
                                               ...
                                               class="form-control dtpic-format" value="{{$vehicleDetail->insurance_exp_date}}">
                    ...
                    <div class="form-group m-form__group  row">
                            ...
                            <input placeholder="Year of manufacture" id="year_of_manufacture"
                                            ...
                                            maxlength="4" value="{{$vehicleDetail->mf_year}}">
                            ...
                            <div class="col-lg-6">
                                    ...
                                    <input placeholder="Year of Registration (Sri Lanka)" id="year_of_sl_registration"
                                                    ...
                                                    class="form-control mxl_phone"
                                                    maxlength="4" value="{{$vehicleDetail->reg_year}}">
                        ...
                        <div class="form-group m-form__group  row">
                                <div class="col-lg-6">
                                        ...
                                        <textarea name="remarks" id="remarks" placeholder="remarks" class="form-control" >{{$vehicleDetail->remarks}}</textarea>
                        ...
                        <div class="m-radio-list">
                            <label class="m-radio m-radio--state-success">
                                <input type="radio" name="status" id="active"  @if ($vehicleDetail->status == 1)
                                    Checked
                                @endif > Active
                                <span></span>
                            </label>
                            <label class="m-radio m-radio--state-brand">
                                <input type="radio" name="status"  id="inactive" @if ($vehicleDetail->status == 0)
                                Checked
                            @endif> In-active
                                <span></span>
                            </label>
            ...
            $( "#frm_submit").click(function( event ) {
                    ...
                    var cur_url=window.location.href; 
                      ...
                      $.ajax({
                        ...
                        url: '{{Route('vehicle_update')}}',
                        method: "POST",
                        data: {id:id,title:title,vehicle_type:vehicle_type,supplier:supplier,
                        ...
                        success: function(data) {
                           ...
                           // console.log(data);
                            ...
                            if(data=='Updated'){
                                $('.alert').hide();
                                swal("Vehicle Vehicle Updated successfully completed!", ""+title, "success");
