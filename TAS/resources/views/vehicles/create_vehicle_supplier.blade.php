            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input required placeholder="unique name" id="name" name="name" type="text"  class="form-control mxl_name"  value="" >
                        <span class="m-form__help text-danger">
                                * Required
                            </span>
                    </div>
                ...
                <div class="form-group m-form__group  row">                    
                    ...
                    <div class="col-lg-4">
                      ...
                      <input placeholder="enter email" id="email" name="email" type="email" class="form-control " value="" required> 
        ...
        $( "#frm_submit").click(function( event ) {
                ...
                var cur_url=window.location.href;                  
                  ...
                  $.ajax({
                    ...
                    url: '{{Route('vehicle_sup_store')}}',
                    method: "POST",
                    data: {code:code,name:name,address:address,city:city,district:district,
                    ...
                    success: function(data) {
                        ...
                        if(data=='added'){
                            $('.alert').hide();
                            swal("Vehicle Supplier Add successfully completed!", ""+name, "success");
