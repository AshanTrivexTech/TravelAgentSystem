            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    <div class="col-lg-6">
                        ...
                        <input id="type" name="type" class="form-control"  type="text" value="" autofocus>
                    ...
                    <div class="col-lg-6">
                      ...
                      <input class="form-control mxl_code" id="code" name="code" type="text" value="" >
                      <div class="form-control-feedback">
                ...
                <div class="form-group m-form__group  row">
                        <div class="col-lg-6">
                                <label class="form-control-label" id="s_id">
                                    Address :
                                </label>
        
                              <input class="form-control " id="symbol" name="symbol" type="text" value="" >
                              <div class="form-control-feedback">
        ...
        $( "#frm_submit").click(function( event ) {
                ...
                var cur_url=window.location.href;
                  ...
                  $.ajax({
                    ...
                    url: '{{Route('currency_store')}}',
                    method: "POST",
                    data: {type:type,code:code,symbol:symbol},
                    success: function(data) {
                        ...
                        if(data=='added'){
                            $('.alert').hide();
                            swal("Currency Add successfully completed!", ""+type, "success");
                            $("#add_currencyFrm")[0].reset();
