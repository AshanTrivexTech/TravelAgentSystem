...
<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <div>
            ...
            <a href="{{route('language_index')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                    <span>
...
<div class="m-content">
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
    <form id="add_holetFrm" method="POST" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" id="add_languagefrm">
            {{csrf_field()}}
            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input required placeholder="name" id="name" name="name" type="text" class="form-control" maxlength="16" value=""> 
                  ...
                  $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if(data=='added'){
                            ...
                            $('.alert').hide();
                            swal("Language Add successfully Completed!", ""+name, "success");
                            $("#add_languagefrm")[0].reset();
                            window.location.replace('{{route('language_index')}}'); 
                            // $("html, body").animate({
                            //         scrollTop: 0
                            //     }); 
