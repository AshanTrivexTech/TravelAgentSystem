...
<div class="m-content">
    ...
    <form method="POST" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" id="add_features">
           {{csrf_field()}}
					...
					// console.log(code);
					  ...
					  $.ajax({
						...
						success: function(data) {
							...
							if(data=='added'){
								$('.alert').hide();
                                swal("Hotel Features Add successfully completed!", ""+name, "success");
