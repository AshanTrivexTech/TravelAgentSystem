              ...
              <table width="100%" class="table table-sm table-bordered">
                  <thead>
                      <tr width="200px" style="text-align: center;">
                          <th colspan="4"><h3>Vehicle Requisition / Log Sheet </h3></th>
                      </tr>
                  </thead>
                  <tbody>
                      <tr>
                          <th width="18%"><h6>Log Sheet No: </h6></th>
                          <td width="40%"><b>00117747</b></td>
                          <th width="18%"><h6>Com.ID: </h6></th>
                          <td width="25%">3398</td>
                      </tr>
                      <tr>
                            <th><h6>Log Sheet Date : </h6></th>
                            <td>09-JUL-2018</td>
                            <th><h6>Total Pax : </h6></th>
                            <td>{{$trns_vouchers[0]->pax}}</td>
                      </tr>
                      
                      <tr>
                            <th><h6>Vehicle Type : </h6></th>
                            <td>{{$trns_vouchers[0]->type}}</td>
                            <th><h6>Report To : </h6></th>
                            <td>{{strtoupper($trns_vouchers[0]->report_to)}}</td>
                      </tr>
      ...
      <div class="row">
            <div class="col-md-12">
                ...
                <table width="100%" class="table table-sm table-bordered">
                    <thead>
                        <tr class="bg-secondary" style="text-align: center;">
                                {{-- <th width="15%">Esti Mileage(Km)</th> --}}
                                <th width="20%">Rates-Per Km(Rs)</th>
                                <th width="15%">Batta(Rs)</th>
                                <th width="15%">Billing Ins</th>
                                <th width="25%">Name of Guide</th>
                        </tr>
                ...
                <tbody style="text-align: center;">
                       <tr>
                           {{-- <td></td> --}}
                           <td>{{number_format($trns_vouchers[0]->rate_pkm,2)}}</td>
                           <td></td>
                           <td></td>
                           <td></td>
                       </tr>
      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <table width="100%" class="table table-sm table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <th width="15%"><h6>Requisition No: </h6></th>
                            <td width="20%"><b>{{$trns_vouchers[0]->trns_voucher_no}}</b></td>
                            <th width="8%"><h6>Tour No: </h6></th>
                            <td width="40%">{{$trns_vouchers[0]->tour_code}}</td>
                        </tr>
                        <tr>
                              <th><h6>Pax Name : </h6></th>
                              <td>Ms.XIAOYU ZHANG & PARTY</td>
                              <th><h6>Requested By : </h6></th>
                              <td>{{strtoupper($trns_vouchers[0]->user_name)}}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                              <th><h6>Requested Date: </h6></th>
                              <td>{{$trns_vouchers[0]->confirm_date}}</td>
                              
                        </tr>
                        <tr>
                              <th><h6>Arrival Flight No: </h6></th>
                              <td>{{strtoupper($trns_vouchers[0]->arrival_flight_no)}}</td>
                              <th><h6>Time: </h6></th>
                              <td width="25%">{{$trns_vouchers[0]->arrival_time}}</td>
                              
                        </tr>
                        <tr>
                                <th><h6>Depature Flight No: </h6></th>
                                <td>{{strtoupper($trns_vouchers[0]->depature_flight_no)}}</td>
                                <th><h6>Time: </h6></th>
                                <td width="25%">{{$trns_vouchers[0]->depature_time}}</td>
