    ...
    <div class="d-flex align-items-center">
        ...
        <div>
            <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                <a href="{{route('hotelgroup_index')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                    <span>
...
<div class="m-content">
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" method="POST" action="" id="add_hotelgroupFrm">
                  {{csrf_field()}}
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    <div class="col-lg-6">
                        ...
                        <input placeholder="unique code" id="code" name="code" type="text" class="form-control mxl_code"  value="">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input placeholder="unique name" id="name" name="name" type="text"  class="form-control mxl_name"  value="" >
                        <span class="m-form__help text-danger">
                                * Required
                            </span>
                    </div>
                ...
                var cur_url=window.location.href;
                  ...
                  $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if(data=='added'){
                            $('.alert').hide();
                            swal("hotel Group Add successfully completed!", ""+name, "success");
                            $("#add_hotelgroupFrm")[0].reset();
                            window.location.replace('{{route('hotelgroup_index')}}');
                            $("html, body").animate({
                                    scrollTop: 0
                                });                               
                        }else{
