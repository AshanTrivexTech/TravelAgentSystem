            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    <div class="col-lg-6">
                        ...
                        <input placeholder="unique code" id="code" name="code" type="text" class="form-control mxl_code"  value="{{$hotel_group_edit->group_code}}">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input placeholder="unique name" id="name" name="name" type="text"  class="form-control mxl_name"  value="{{$hotel_group_edit->hotel_gp_name}}" >
                        <span class="m-form__help text-danger">
                                * Required
                            </span>
...
<script>
    $(document).ready( function(){ 
        ...
        $("#frm_submit").click(function(event) {
                ...
                var code = $('#code').val();
                var name = $('#name').val();
                var id='{{$hotel_group_edit->id}}';
                var cur_url=window.location.href;
                     //console.log(data);
                    //Send Ajax request 
                    $.ajax({
                    
                        url: '{{Route('hotelgroup_update')}}',
                        method: "POST",
                            ...
                            //if Added 
                                if(data=='updated'){
                                    $('.alert').hide();
                                    swal("Hotel Group Updated successfully!", ""+name, "success");
