...
<div class="m-content">
    ...
    <form id="add_guideroomFrm" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" >
            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group  row">
                        <div class="col-lg-3">
                                ...
                                <select required name="hotel" id="hotel" class="form-control m-bootstrap-select m_selectpicker" data-live-search="true">  
                        ...
                        <div class="col-lg-3">
                            ...
                            <select required name="room_type" id="room_type" class="form-control m-bootstrap-select m_selectpicker" data-live-search="true"> 
                                
                                    <option value="0">Please Select</option> 
                                    @foreach($guideroomtypes as $guideroomtype )
                                    <option value="{{$guideroomtype->id}}">{{$guideroomtype->gr_types}}</option>
                                    @endforeach 
                        ...
                        <div class="col-lg-3">
                                ...
                                <select required name="currency_type" id="currency_type" class="form-control m-bootstrap-select m_selectpicker" data-live-search="true">
                                    <option value="0">Please Select</option>
            ...
            $( "#frm_submit").click(function( event ) {
                    ...
                    var cur_url=window.location.href;           
                      ...
                      $.ajax({
                        ...
                        url: '{{Route('guideroom_store')}}',
                        method: "POST",
                        data: {hotel:hotel,room_type:room_type,currency_type:currency_type,amount,amount},
                        success: function(data) {
                            ...
                            if(data=='added'){
                                $('.alert').hide();
                                swal("Guide Room Add successfully completed!", "success");
                                $("#add_guideroomFrm")[0].reset();
