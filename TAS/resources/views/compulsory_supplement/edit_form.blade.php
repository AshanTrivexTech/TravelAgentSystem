            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    <div class="col-lg-2">
                        ...
                        <input required disabled placeholder="unique code" id="code" name="code" type="text" class="form-control mxl_code" value="{{ $compulsory_supplement->cs_code}}">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input required placeholder="unique name" id="amount" name="amount" type="text"  class="form-control numeric_only"  value="{{$compulsory_supplement->amt}}" >
                        <span class="m-form__help text-danger">
                                * Required
                        </span>
                    </div>
                    ...
                    <select class="form-control" id="currency" name="currency">
                        @foreach($currencies->all() as $currency)				
                            <option value="{{$currency->id}}" @if($currency->id==$compulsory_supplement->currency_id)selected @endif >{{$currency->type}}</option>                                       
                        @endforeach
                    </select>
                ...
                <div class="form-group m-form__group has-danger row">
                       ...
                       class="form-control dtpic-format" value="{{$compulsory_supplement->fr_date}}">
                       <span class="m-form__help text-danger">
                            * Required
                        </span>
                        </div>
                       ...
                       class="form-control dtpic-format" value="{{$compulsory_supplement->to_date}}">
                       <span class="m-form__help text-danger">
                            * Required
                        </span>
                        </div>
                        ...
                        <select class="form-control" id="rate_type" name="rate_type">
                                    ...
                                    <option value="0" @if ($compulsory_supplement->rate_type == 0) Selected  @endif>Per-Person</option>
                                    <option value="1" @if ($compulsory_supplement->rate_type == 1) Selected  @endif>per-Room</option>
                ...
                <div class="form-group m-form__group  row">
                    <div class="col-lg-4">
                        ...
                        <input placeholder="Description" id="desc" name="desc" class="form-control"  value="{{$compulsory_supplement->des}}">                       
                    </div>
                </div>   
...
<script>
    $(document).ready( function(){ 
        ...
        $("#frm_submit").click(function(event) {
                ...
                var id='{{$compulsory_supplement->id}}';
                var cur_url=window.location.href;
                // console.log();
                    //Send Ajax request 
                    $.ajax({
                    
                        url: '{{Route('comsup_update')}}',
                        method: "POST",
                            data: {code:code,amount:amount,desc:desc,from_date:from_date,to_date:to_date,currency:currency,
                                   rate_type:rate_type,id:id},
