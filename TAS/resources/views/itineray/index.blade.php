    ...
    <div class="d-flex align-items-center">
        ...
        <div>
            <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                  @if($add_pv==1)
                <a href="{{route('itineray_create')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                    <span>
        ...
        <div class="m-portlet__body">
            ...
            <table class="table table-bordered table-hover table-checkable">
                ...
                <tbody id='tb_sr'>
                    ...
                    <td style="text-align: center">{{$i_data->id}}</td>
                    ...
                    <td>
                        @foreach($it_data as $loc)
                            ...
                            <span class="m-badge m-badge--secondary m-badge--wide m-badge--rounded">{{$loc->location_code}} </span>
                    ...
                    <td>{{str_limit($i_data->dec,45)}}</td>

                    <td style="text-align: center">

                     @if($edit_pv==1)
                    <a href="{{route('itineray_edit',$i_data->id)}}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details"><i class="la la-edit">
                        </i>
                    </a>
                    @endif    
                        @if($del_pv==1)
