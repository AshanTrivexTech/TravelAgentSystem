   ...
   <div class="m-portlet__body">
        ...
        <div class="form-group m-form__group row">
		 ...
		 <div class="form-group m-form__group row">
            ...
            <input  name="lkr_rate" id="lkrc_rate"  type="text"  class="form-control m-input numeric_only" placeholder="0.00">          
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-4">
                <label class="form-control-label" data-html="true" data-placement="right" data-toggle="m-tooltip" data-original-title="Pax Adult Count">
                    Number of Pax (Adult):
                </label>
    ...
    $('input[type=radio][name=date_range]').change(function(event){
        // if($('#qt_type').val() == 1){
            if (this.value == 'days') {
                ...
                $('#lbl_eddate').html('End Date');
                $('#lbl_stdate').html('Start Date');
            }
        // }
    });        
            ...
            var cur_url=window.location.href;
              ...
              $.ajax({
                ...
                data: {title:title,days:days,frm_date:frm_date,to_date:to_date,com_rate:com_rate,
                         ...
                         qtType:qtType,version_no:version_no,base_on:base_on,con_rate:con_rate},
                success: function(data) {
