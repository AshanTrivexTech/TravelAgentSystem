<form class="cleafix" method="POST" action="">
    ...
    @php
        ...
        if($tourRoomallocation!='')
        {
            //foreach ($tourRoomallocation as $tour_rm_allocation) {

                $al_sgl = $tourRoomallocation->sgl;
                $al_dbl = $tourRoomallocation->dbl;
                $al_twn = $tourRoomallocation->twn;
                $al_tbl = $tourRoomallocation->tbl;
                $al_qd = $tourRoomallocation->qd;
    ...
    <br/>
        <div class="row">
            <div class="col-md-4">
                ...
                <a href="{{Route('download_quotation',$tourQuotHeader->id)}}" @if($tourQuotStatus!=3&&$tourQuotConf!=1) @endif    class="btn btn-primary m-btn m-btn--icon m-btn--wide" type="button" style="color: white" >
                                <span>
                                        <i class="la la-check-circle-o"></i>
