...
<div class="m-portlet__head">
									...
									<div class="m-portlet__body">
										<ul class="nav nav-pills" role="tablist" id="main_tab">
										
											<li class="nav-item">
												<a onclick="change_tab(1)" class="nav-link active show" id="tab_index_1" data-toggle="tab" href="#m_tabs_3_1">
											...
											<li class="nav-item">
													<a onclick="change_tab(2)" class="nav-link" data-toggle="tab" id="tab_index_2" href="#m_tabs_3_2">
											...
											<li class="nav-item">
													...
													<a onclick="change_tab(3)" class="nav-link" data-toggle="tab" id="tab_index_3" href="#m_tabs_3_3">
											...
											<li class="nav-item">
													<a onclick="change_tab(4)" class="nav-link" data-toggle="tab" id="tab_index_4" href="#m_tabs_3_4">
											...
											<li class="nav-item">
													<a onclick="change_tab(5)" class="nav-link" data-toggle="tab" id="tab_index_5" href="#m_tabs_3_5">
														<i class="la la-car"></i>
														Transport
													</a>
												</li>
											...
											<li class="nav-item">
													<a onclick="change_tab(6)" class="nav-link" data-toggle="tab" id="tab_index_6" href="#m_tabs_3_6">
														<i class="la la-cog"></i>
														Miscellaneous
													</a>
												</li>
											...
											<li class="nav-item">
													<a onclick="change_tab(7)" class="nav-link" data-toggle="tab" id="tab_index_7" href="#m_tabs_3_7">
											...
											@if ($tourQuotHeader->qtn_type == 2)
												<li class="nav-item">
														<a onclick="change_tab(8)" class="nav-link" data-toggle="tab" id="tab_index_8" href="#m_tabs_3_8">
															<i class="la la-file-text"></i>
															Group Summary
														</a>
												</li>
											@endif
											<li class="nav-item">
													<a onclick="change_tab(9)" class="nav-link" data-toggle="tab" id="tab_index_9" href="#m_tabs_3_9">
												...
												<li class="nav-item">
													<a onclick="change_tab(10)" class="nav-link" data-toggle="tab" id="tab_index_10" href="#m_tabs_3_10">
														<i class="la la-file-word-o"></i>
														Confirmation
