<h5 class="breadcrumbs-title"><i class="material-icons">attach_money</i>  Add Location Payments</h5>
<br>
<form class="cleafix" method="POST" action="">
  ...
  <div class="row"> 
    ...
    <div class="input-field col s12 m4 l4 pull-right"> 
         <button class="btn waves-effect green dark-2 pull-right" type="submit" name="action">Add</button>
    </div>
