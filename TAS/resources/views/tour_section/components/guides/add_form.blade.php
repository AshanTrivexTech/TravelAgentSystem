<form class="cleafix" method="POST">
   ...
   if($cur_ex_dt_rate != '')
   {     
        $exrateGuidelkrtobase = $cur_ex_dt_rate->amount;
    ...
    @endphp
                           ...
                           <div class="m-form__actions m-form__actions--solid">
                               <div class="row">
                                   <div class="col-lg-2">
                                       ...
                                       <button id="btn_save_tab_3" class="btn btn-primary onClick_save" @if($data_status->confirmed==0 && $data_status->status==4) disabled @endif type="button" onclick="guideSave()" >Save Guide Details</button>
                                 </div>
                               </div>
                           </div>
                   </div>
       ...
       {{-- <td><b>Total Markup :</b></td>
                            <td><b>Total :</b></td>                           
                            <td><b>LKR to {{$baseCurrncyCode}}</b></td>
                            <td><b>Room Cost :</b></td>
                            <td><b>Room Markup :</b></td>
