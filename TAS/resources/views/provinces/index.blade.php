                                ...
                                <div class="m-input-icon m-input-icon--left">
                                    ...
                                    <span class="m-input-icon__icon m-input-icon__icon--left">
													...
													<div class="m-form__group m-form__group--inline">
														...
														<select name="country_ids" class="form-control m-bootstrap-select" id="m_form_status">
                ...
                <tbody>
                    ...
                    <td></td>
                        <td class="m-datatable__cell--right">
                            ...
                            <!-- <a href="" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="View "><i class="la la-eye"></i> </a>
