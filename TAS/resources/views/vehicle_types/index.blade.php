    ...
    <div class="d-flex align-items-center">
        ...
        <div>
            <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                  @if($add_pv==1)
               <a href="{{route('create_vehicle')}}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
        ...
        <div class="m-portlet__body">
            ...
            <table class="table table-bordered table-hover table-checkable">
                    ...
                    <tbody id="vType">
                        ...
                        <td>            
                                       @if($edit_pv==1)
                                    <a href="{{route('edit_vehicle',$vehicle->id)}}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">
