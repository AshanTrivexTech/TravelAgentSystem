...
<div class="m-content">
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" method="POST" id="add_vtypeFrm">
          {{ csrf_field() }}
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    <div class="col-lg-6">
                        <label class="form-control-label">
                          ...
                          <input class="form-control" id="type" name="type" type="text" value="" autofocus>
                    ...
                    <div class="col-lg-6">
                        ...
                        <input  class="form-control mxl_phone" id="nos" name="nos" type="text" value="" >
                        <span class="m-form__help text-danger">
                                * Required
                            </span>
                    </div>
                ...
                <div class="form-group m-form__group  row">
                    <div class="col-lg-6">
                        ...
                        <input class="form-control m-input numeric_only" id="rate_per_km" name="rate_per_km" type="text">
        ...
        $( "#frm_submit").click(function( event ) {
                ...
                var cur_url=window.location.href;          
                  ...
                  $.ajax({
                    ...
                    url: '{{Route('store_vehicle')}}',
                    method: "POST",
                    data: {type:type,nos:nos,rate_per_km:rate_per_km},
                    success: function(data) {
                        ...
                        if(data=='added'){
                            $('.alert').hide();
                            swal("Vehicle type Add successfully completed!", ""+type, "success");
                            $("#add_vtypeFrm")[0].reset();
                            $("html, body").animate({
                                    scrollTop: 0
                                });    
