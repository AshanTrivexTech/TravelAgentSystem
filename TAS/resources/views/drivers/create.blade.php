...
<div class="m-content">
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
    <form  method="POST" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" id="add_driverfrm">
            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input required placeholder="driving licence number" id="l_no" name="l_no" type="text" class="form-control mxl_liceno"  value="">
                        <span class="m-form__help text-danger">
                                * Required
                            </span>  
                    </div>
                ...
                <div class="form-group m-form__group  row">
                        <div class="col-lg-4">
                              ...
                              <input placeholder="011XXXXXXXX" id="tel" name="tel" type="tel" class="form-control mxl_phone" maxlength="191" value="" required >
                              <span class="m-form__help text-danger">
                                    * Required
                                </span>
                            </div>
        ...
        $( "#frm_submit").click(function( event ) {
                ...
                var cur_url=window.location.href;
                  ...
                  $.ajax({
                    ...
                    url: '{{Route('driver_store')}}',
                    method: "POST",
                    data: {name:name,l_no:l_no,address:address,tel:tel,email:email},
                    ...
                    success: function(data) {
                        ...
                        if(data=='added'){
                            $('.alert').hide();
                            swal("Driver Add successfully completed!", ""+name, "success");
                            $("#add_driverfrm")[0].reset();
